SITE_LOCALES.it = {
  ...
  footer: {
    ...
    instagram: "Instagram",
    aiNote:
      "Contenuti, design e codice sviluppati con il supporto dell'IA sotto direzione accademica umana.",
  },
  packagesUi: {
    live: "Online",
  ...
  home: {
    ...
    final: {
      title: "Da $6.99 a modulo. Risparmia fino al 30% acquistando di più.",
  ...
  precos: {
    ...
    pricing: {
      ...
      volumeTitle: "Compra di più, risparmia di più",
      volume4: "4 moduli — 10% di sconto",
      volume8: "8 moduli — 15% di sconto",
      volume12: "12 moduli — 20% di sconto",
      volume22: "Tutti i 22 moduli — 30% di sconto",
      volumeNote:
        "Lo sconto si applica al totale combinato al checkout. Ogni modulo è prezzato in base al numero di temi — vedi la tabella sopra.",
