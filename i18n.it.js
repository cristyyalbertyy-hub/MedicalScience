SITE_LOCALES.it = {
  ...
  home: {
    ...
    final: {
      ...
      text: "Compra una disciplina, o sblocca tutte e quindici mentre studi il semestre.",
  ...
  precos: {
    ...
    paths: {
      ...
      passLead: "Per chi porta più discipline nello stesso semestre.",
      passF1: "Tutti i 15 moduli a pagamento sbloccati mentre è attivo",
      passF2: "Cambia materia man mano che arrivano gli esami",
      passF3: "Progressi lungo il semestre",
      passF4: "Aggiornamenti inclusi — senza tutor 24 ore su 24",
    ...
    passWhy: {
      ...
      lead: "I pacchetti restano la scelta giusta per una sola materia. Studio9 Pass è per i mesi in cui la medicina ti chiede di portarne diverse insieme — senza comprare ogni modulo a parte.",
      ...
      c3Title: "Supporto senza agente 24/7",
      c3Text:
        "Il Pass si basa su accesso continuo, aggiornamenti e progressi — non su un tutor privato sempre online. Aiuto umano via email entro 24 ore.",
    },
    pricing: {
      eyebrow: "Nessuna sorpresa",
      title: "Prezzi semplici.",
      pilotNotice:
        "Compra una disciplina quando ti serve — o sblocca tutto con Studio9 Pass mentre studi il semestre.",
      ...
      tierSRange: "1–9 temi",
      tierMLabel: "Medium",
      tierMRange: "10–19 temi",
      tierLLabel: "Large",
      tierLRange: "20+ temi",
      tierItem1: "40–60h di studio",
