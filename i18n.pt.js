SITE_LOCALES.pt = {
  ...
  screenshots: {
    ...
    podcasts: { alt: "A ouvir um podcast de ciências médicas no autocarro" },
  ...
  home: {
    ...
    preview: {
      eyebrow: "Pré-visualização do programa",
      title: "O programa — três anos, mês a mês.",
      intro:
        'Abaixo estão algumas disciplinas. No final da página, consulta o <a href="curriculo/">programa completo</a>.',
      m1Title: "Biologia e Genética",
      m1Text: "Células, herança e bases da genética clínica.",
      m2Title: "Anatomia Humana I",
      m2Text: "Sistemas esquelético, muscular e nervoso.",
      m2Link: "Abrir pacote →",
      m3Title: "Genética Médica",
      m3Text: "Herança, mutações, distúrbios genéticos.",
      m4Title: "Fisiologia I",
      m4Text: "Sistemas cardiovascular e respiratório.",
      allLink: "Ver as 22 disciplinas →",
    },
    packages: {
  ...
  precos: {
    ...
    steps: {
      ...
      s4Text:
        'Consulta o que completaste e o que falta, disciplina a disciplina. <a class="text-link" data-student-progress target="_blank" rel="noopener noreferrer">Abrir painel de progresso →</a>',
    },
    pricing: {
      ...
      p1Price: "€15",
      p1l1: "40-60h de estudo",
      p1l2: "Acesso imediato (1 ano)",
      p1l3: "Vídeos + podcasts + exercícios + resumo",
      p1cta: "Escolher um módulo →",
      p2Label: "Pack de 4 módulos",
      p2Price: '€50 <span>€12,50 cada</span>',
      p2l1: "4 módulos à tua escolha",
      p2l2: "Acesso imediato (1 ano)",
      p2l3: "Poupa 25% face à compra individual",
      p2cta: "Montar o teu pack →",
      p3Label: "Ano completo",
      p3Price: "€120 <span>€15 por mês com pagamento anual</span>",
      p3l1: "1 ano completo do programa",
      p3l2: "Acesso imediato (1 ano + 6 meses extra)",
      p3l3: "Poupa 40% face à compra individual",
      p3cta: "Ver os anos →",
      p4Label: "Curso completo",
      p4Price: "€300 <span>equivalente a €10/mês</span>",
      p4l1: "Todos os 22 módulos ao longo dos 3 anos",
      p4l2: "Acesso vitalício (enquanto a app existir)",
      p4l3: "Poupa 58% face à compra individual",
      p4cta: "O mais popular → Quero tudo",
    },
    faq: {
