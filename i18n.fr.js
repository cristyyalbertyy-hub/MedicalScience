SITE_LOCALES.fr = {
  ...
  home: {
    ...
    final: {
      ...
      text: "Achetez une discipline, ou débloquez les quinze pendant le semestre.",
  ...
  precos: {
    ...
    paths: {
      ...
      passLead: "Pour celles et ceux qui portent plusieurs disciplines le même semestre.",
      passF1: "Les 15 modules payants débloqués tant que c'est actif",
      passF2: "Changez de matière à l'approche des examens",
      passF3: "Suivi de progression sur le semestre",
      passF4: "Mises à jour incluses — sans tuteur 24h/24",
    ...
    passWhy: {
      ...
      lead: "Les packs restent le bon choix pour une seule matière. Studio9 Pass est pour les mois où la médecine vous demande d'en porter plusieurs — sans acheter chaque module séparément.",
      ...
      c3Title: "De l'aide sans agent 24h/24",
      c3Text:
        "Le Pass repose sur l'accès continu, les mises à jour et la progression — pas sur un tuteur privé toujours en ligne. Aide humaine par email sous 24 heures.",
    },
    pricing: {
      eyebrow: "Sans surprise",
      title: "Tarifs simples.",
      pilotNotice:
        "Achetez une discipline quand vous en avez besoin — ou débloquez tout avec Studio9 Pass pendant le semestre.",
