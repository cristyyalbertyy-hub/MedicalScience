SITE_LOCALES.fr = {
  ...
  screenshots: {
    hero: { alt: "Étudiant avec un casque étudiant les sciences médicales à domicile" },
  ...
  home: {
    hero: {
      ...
      mediaAria: "Étudiant révisant à domicile",
    },
    audience: {
  ...
  precos: {
    ...
    steps: {
      ...
      s1Text: "Achetez un module, un pack de quatre ou plus.",
